		...
		<html>
			...
			<body
				...
				<xsl:for-each select="$XML">
					<table style="border-color:blue; " border="0" cellspacing="0px" width="545"
						cellpadding="0px">
						<tbody >
							<tr valign="top">
								<td width="40%">
					...
					<table border="1" id="lineTable" width="545">
						<tbody>
				...
				<table id="budgetContainerTable" table-layout="fixed" width="545" style = "padding-left : 60%;">
					<tbody>
						<tr>
						<xsl:if
				...
				<table id="notesTable" width="545" align="left">
					<tbody>
						<tr align="left">
